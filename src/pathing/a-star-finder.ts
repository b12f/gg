...
import { backtrace } from './path-util';

export class AStarFinder {
    public allowDiagonal = true;
    public heuristicFilter = null;
    public list = new LinkedList();

    constructor(
        settings = { allowDiagonal: false, heuristicFilter: null }
    ) {
	 ...
	 */
	public findPath(startNode, endNode, heuristic, grid) {
